...
import com.jinshuai.seckill.common.config.RoutingDataSourceContext;
...
public class DataSourceAspect {
    ...
    @Before("@annotation(com.jinshuai.seckill.common.annotation.TargetDataSource)")
    ...
    @After("@annotation(com.jinshuai.seckill.common.annotation.TargetDataSource)")
    public void doAfter() {
        RoutingDataSourceContext routingDataSourceContext = RoutingDataSourceContext.getInstance();
